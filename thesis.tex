...
\ifpdf
  ...
  \usepackage[pdftex,colorlinks,%
              ...
              pdfauthor={Kambale Wesley},%
              pdftitle={An Outbreak Prediction System for Rota-virus using Naive Bayes},%
              pdfsubject={Undergraduate Research},%
              pdfkeywords={Outbreak, Prediction, Rotavirus, Naive Bayes},%
...
\newpage\input{Approval.tex} %%%%%% call this file %%%%%%%%%

{\doublespacing
\newpage\ifpdf\pdfbookmark[1]{Acknowledgement}{label:ack}\fi\input{acknowledge.tex}
\newpage\ifpdf\pdfbookmark[1]{Dedication}{label:ded}\fi\input{dedication.tex}
